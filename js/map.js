am4core.ready(function() {
  ...
  chart.backgroundSeries.mapPolygons.template.polygon.fill = am4core.color("#2B5FBA");
  ...
  template.fill = am4core.color("#50A385");
  ...
  hs.properties.fill = am4core.color("#31604e");
  ...
  measelTemplate.fill = am4core.color("#ff5a2e");
  ...
  hs2.properties.fill = am4core.color("#ff9c39");
...
//   $.getJSON("../js/result.json",function(area){
//     var data = {};
//     $.each(area,function(a,getarea){
//       data = `${getarea.id} : ${getarea.value}`
//     });
//   });
